...
import { helpers } from 'sdk/web3-react';
...
const walletsButtons: { [K in WalletId | string]: FC<ConnectInjectedProps> } = {
...
const getWalletButton = (
  ...
  // @ts-ignore
  React.createElement(walletsButtons[name], {
    key: name,
    ...props,
  });
...
export const WalletsModalForEth = (
